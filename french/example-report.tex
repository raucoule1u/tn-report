...
Préciser que dans ce chapitre on appelle une liste de confiance Trust Service List (TSL).
...
\begin{figure}[h]
	...
	\caption{EDITER CE DIAGRAMME EN Y AJOUTANT LES FONCTIONNALITES NON REPERTORIEES - Diagramme de cas d'utilisation}
